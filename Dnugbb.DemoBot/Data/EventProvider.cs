            ...
            get
            {
                return new[]
                {
                    new Event()
                    {
                        ...
                        EventUrl = "http://dnugbb.azurewebsites.net/events/conversational-uis-intelligente-bots-next-big-thing-oder-nur-hype-ein-ueberblick/"
                    },
                    new Event()
                    {
                        ...
                        EventUrl = "http://dnugbb.azurewebsites.net/events/micro-apps-mit-uwp-windows-10-anniversary-update/"
                    },
                    new Event()
                    {
                        ...
                        EventUrl = "http://dnugbb.azurewebsites.net/events/net-core-mssql-container-und-kubernetes/"
                    }
                };
            }
        }
